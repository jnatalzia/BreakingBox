...
/* Method purpose: Initializs the frame and sets number of levels*/
...
/* Method purpose: Draws all level buttons to the screen*/
...
/* Method purpose: tests for which level button was clicked*/
